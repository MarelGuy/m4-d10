    ...
    return (
        <>
            ...
            <Nav className="flex-column d-none d-md-block" id="side-bar">
                ...
                <Nav.Item>
                    <Nav.Link className="text-white"><svg width="1.5em" height="2em" viewBox="0 0 16 16" className="bi bi-house-door mr-3 ml-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <Nav.Item>
                    <Nav.Link className="text-white"><svg width="1.5em" height="2em" viewBox="0 0 16 16" className="bi bi-bar-chart-line mr-3 ml-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
